const Contacts = () => {
  return (
    <div
      id='Contacts'
      className={`flex flex-col justify-center items-center w-full h-screen md:h-full bg-bg_qr_image bg-fixed gap-24 py-64 px-6 text-lg sm:text-2xl text-center text-white sm:px-12 lg:px-36 `}
    >
      <p>
