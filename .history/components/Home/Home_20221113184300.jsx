...
const Home = () => {
  ...
  return (
    <header className='flex-col md:flex-row flex justify-center items-center w-full h-screen px-4 md:px-8 lg:px-20 bg-fixed bg-repeat bg-bg_gear_image'>
      <section
        ref={ref}
        className='w-full flex flex-col justify-center items-center sm:w-4/12 space-y-4'
      >
        <div className='flex flex-col gap-2.5 place-items-start'>
          <h1
            className={`text-base sm:text-xl font-thin text-white ${styles.typingLet}`}
          >
            Hi there!
          </h1>
