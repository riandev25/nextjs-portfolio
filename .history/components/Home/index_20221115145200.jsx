...
const Home = () => {
  ...
  return (
    <header
      id='Home'
      className='flex flex-col justify-center items-center max-w-full h-screen bg-bg_gear_image bg-fixed bg-repeat blur-sm px-6 sm:px-12 lg:px-24 md:flex-row'
    >
      <section
        ref={ref}
