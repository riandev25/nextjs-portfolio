  ...
  return (
    <header className='flex justify-center items-center w-full h-screen px-20'>
      <section className='w-6/12'>
        <div className=''>
          <h1 className='text-xl font-light text-white'>Hello!</h1>
          <h1 className='text-3xl text-white font-bold'>Im Rian Miguel</h1>
          <h1 className='text-xl text-white font-bold'>
            <span className='text-xl font-light'>a</span> Full Stack Developer
          </h1>
        </div>
