...
const Home = () => {
  ...
  return (
    <header className='flex-col md:flex-row flex justify-center items-center max-w-full h-screen px-4 md:px-8 lg:px-20 bg-fixed bg-repeat bg-bg_gear_image'>
      <section
        // ref={ref}
        className='flex flex-col justify-center items-start md:items-center md:w-5/12 gap-5 bg-black'
      >
        <div className='flex flex-col justify-center items-center md:justify-start md:items-start'>
          ...
          <h1 className='text-lg sm:text-5xl font-bold animate-neon_text'>
            I&apos;m Rian Miguel
          </h1>
        ...
        <ul className='flex flex-row justify-start items-start md:justify-center md:items-center gap-4'>
          {CONTACTS.map((item) => {
