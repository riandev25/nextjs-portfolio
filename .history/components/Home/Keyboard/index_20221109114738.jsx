const Keyboard = () => {
  return (
    <div class='case'>
      ...
      {/* <!-- Third row --> */}
      <div class='key xl' data-key='capslock'>
        caps
      </div>
      ...
      <div class='key' data-key=';'></div>
      <div class='key' data-key="'"></div>
      <div class='key xl' data-key='enter'>
        return
      </div>
      <div class='key' data-key='f15'>
        pause
      </div>
      ...
      {/* <!-- Fourth row --> */}
      <div class='key xxl' data-key='shiftleft'>
        shift
      </div>
      ...
      <div class='key' data-key='.'></div>
      <div class='key' data-key='/'></div>
      <div class='key xxl' data-key='shiftright'>
        shift
      </div>
      ...
      {/* <!-- Fifth row --> */}
      <div class='key medium' data-key='controlleft'>
        ctrl
      </div>
      <div class='key medium' data-key='meta'>
        win
      </div>
      <div class='key medium' data-key='altleft'>
        alt
      </div>
      <div class='key huge' data-key=' '></div>
      <div class='key medium' data-key='altright'>
        alt
      </div>
      <div class='key medium' data-key='fn'></div>
      <div class='key medium' data-key='controlright'>
        ctrl
      </div>
