...
const Keyboard = () => {
  return (
    <div className={styles.case}>
      ...
      <div className={styles.key} data-key='1'></div>
      ...
      <div className={styles.key} data-key='help'>
        ins
      </div>
      <div className={styles.key} data-key='home'></div>
      {/* <!-- Second row --> */}
      ...
      <div className={styles.key} data-key='delete'>
        del
      </div>
      <div className={styles.key} data-key='end'></div>
      {/* <!-- Third row --> */}
      ...
      <div className={styles.key} data-key='f15'>
        pause
      </div>
      <div className={styles.key} data-key='pageup'>
        pg up
      </div>
      {/* <!-- Fourth row --> */}
      <div className={`${styles.key} ${styles.xxxl}`} data-key='shiftleft'>
        shift
      </div>
      ...
      <div className={styles.key} data-key='.'></div>
      <div className={styles.key} data-key='/'></div>
      <div className={`${styles.key} ${styles.large}`} data-key='shiftright'>
        shift
      </div>
      <div className={styles.key} data-key='arrowup'>
        ▲
      </div>
      <div className={styles.key} data-key='pagedown'>
        pg dn
      </div>
      {/* <!-- Fifth row --> */}
