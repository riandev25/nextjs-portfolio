...
const Home = () => {
  ...
  return (
    <header className='flex-col md:flex-row flex justify-center items-center max-w-full h-screen px-4 md:px-8 lg:px-20 bg-fixed bg-repeat bg-bg_gear_image'>
      <section
        // ref={ref}
        className='flex flex-col justify-center items-center md:items-start md:w-4/12 gap-5 bg-black'
      >
      ...
      <section className='hidden md:flex w-[32rem] h-full justify-center items-center'>
        <Image
          src={DevImage}
          alt='dev-image'
          width={500}
