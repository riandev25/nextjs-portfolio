...
const Home = () => {
  ...
  return (
    <header
      id='Home'
      className='flex flex-col justify-center items-center max-w-full h-screen bg-bg_gear_image bg-fixed bg-repeat blur-md px-6 sm:px-12 lg:px-24 md:flex-row'
    >
      <section
        ref={ref}
      ...
      >
        <div className='flex flex-col justify-center items-center gap-2 md:justify-start md:items-start'>
          ...
          <h1 className='text-base font-bold text-white sm:text-xl'>
            <span className='text-base font-thin sm:text-xl'>a</span> Full Stack
            Developer
          </h1>
        </div>
