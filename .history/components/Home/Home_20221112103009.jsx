...
const Home = () => {
  ...
  return (
    <header className='flex justify-center items-center w-full h-screen px-20 bg-fixed bg-repeat bg-bg_home_image'>
      <section ref={ref} className='w-4/12 space-y-4'>
        <div className='flex flex-col gap-2.5 place-items-start'>
          <h1 className={`text-xl font-thin text-white ${styles.typingLet}`}>
            Hi there!
          </h1>
          <h1 className='text-6xl text-white font-bold animate-neon_1s'>
            I&apos;m Rian Miguel
          </h1>
