...
const Navbar = ({ handleClick, drawer }) => {
  const data = [
    {
      id: 'Home',
    },
  ...
  return (
    <div
      className={`z-[60] ${
        !drawer && 'hidden'
      } bg-red-400 absolute top-0 right-0 justify-between items-center w-[70%] h-screen flex bg-gray-800 md:relative md:w-auto md:order-1`}
      id='navbar-sticky'
    >
      <div className='h-screen relative flex justify-center items-center flex-auto bg-bg_gear_code bg-repeat'>
        <button
          type='button'
