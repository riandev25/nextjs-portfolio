...
const Navbar = () => {
  ...
  return (
    <div
      className={`z-[60] flex md:hidden absolute top-0 right-0 justify-between items-center w-[70%] max-h-screen md:h-full bg-gray-800 shadow-md transform ease-in-out 
      ${
        drawer
