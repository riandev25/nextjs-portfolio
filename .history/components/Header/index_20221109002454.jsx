    ...
    <nav className='px-8 py-1 dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b md:px-20 md:py-3 border-gray-200 dark:border-gray-600'>
      <div className='flex flex-row justify-between items-center w-full'>
        ...
        <div className='flex md:order-2'>
          <button
            type='button'
            className='hidden lg:flex text-[#b2fcfb] border border-[#b2fcfb] hover:bg-[#b2fcfb] hover:opacity-40 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'
          >
            Get started
          </button>
          <button
