...
const Navbar = () => {
  ...
  return (
    <div
      className={`z-[60] ${
        !drawer && 'hidden'
      }  absolute top-0 right-0 justify-between items-center w-[70%] h-screen md:h-full flex bg-gray-800 shadow-md md:relative md:w-auto md:order-1`}
      id='navbar-sticky'
    >
      <div className='md:h-screen h-auto relative flex justify-center items-center flex-auto'>
        <button
          type='button'
