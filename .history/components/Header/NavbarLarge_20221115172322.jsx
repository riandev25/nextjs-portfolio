...
const Navbar = () => {
  ...
  return (
    <div
      className={`z-[60] justify-between items-center transition md:h-full flex bg-gray-800 shadow-md transform ease-in-out 
      ${
        drawer
          ? 'transition-opacity opacity-100 duration-500 translate-x-0'
          : 'transition-all delay-300 translate-x-full'
      } relative w-auto order-1 bg-transparent shadow-none`}
      id='navbar-sticky'
    >
