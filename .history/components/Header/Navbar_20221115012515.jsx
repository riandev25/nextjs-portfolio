    ...
    >
      <div className='relative flex justify-center items-center flex-auto h-screen bg-black'>
        <button
          ...
          type='button'
          className='absolute cursor-pointer inline-flex items-center p-2 text-sm text-neon rounded-lg md:hidden hover:text-gray-800 hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600'
