      ...
      <div className='flex flex-row justify-between items-center w-full'>
        ...
        <div className='flex md:order-2'>
          ...
          <button
            ...
            type='button'
            className='inline-flex items-center p-2 text-sm bg-white rounded-lg md:hidden hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600'
