...
const Navbar = () => {
  ...
  return (
    <div
      className={`z-[60] opacity-100 absolute top-0 right-0 justify-between items-center transition w-[70%] h-screen md:h-full flex bg-gray-800 shadow-md transform ease-in-out 
      ${
        drawer
          ? 'transition-opacity opacity-0 duration-500 translate-x-0'
          : 'transition-all delay-300 translate-x-full'
      } md:relative md:w-auto md:order-1 md:bg-transparent md:shadow-none md:translate-x-full`}
      id='navbar-sticky'
    >
