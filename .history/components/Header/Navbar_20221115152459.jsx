...
const Navbar = () => {
  ...
  return (
    <div
      className={`z-[60] ${
        !drawer && 'hidden'
      }  absolute top-0 right-0 justify-between items-center w-[70%] h-screen md:h-full flex bg-gray-800 shadow-md md:relative md:w-auto md:order-1 md:bg-transparent md:border-0`}
      id='navbar-sticky'
    >
