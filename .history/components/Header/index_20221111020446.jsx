...
const Header = () => {
  return (
    <nav className='px-8 py-1 bg-gray-700 dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b shadow-lg border-gray-700 md:px-20 md:py-3 dark:border-gray-600'>
