  ...
  return (
    ...
    >
      ...
      >
        ...
        <section className='z-40 group relative flex flex-col bg-white shadow-md shadow-[#b2fcfb] border-2 border-[#b2fcfb] w-full md:w-8/12 p-7 gap-8 rounded-lg image-filter'>
