  ...
  return (
    <div className='pt-4 flex flex-col w-full h-screen gap-11 justify-center items-center text-white px-20 bg-bg_about_image bg-fixed'>
      <div className='overflow-visible flex justify-center items-center'>
        <h1 className='z-10 w-24 text-2xl flex flex-start bg-gray-700 px-4'>
          Technologies
        </h1>
      ...
      <div className='max-w-4xl flex flex-row'>
        ...
        <section className='w-full grid-rows-3 border-2 border-[#b2fcfb] w-[500px]'>
          {frontend}
          {backend}
          {tools}
          {soon}
