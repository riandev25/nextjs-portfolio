...
const Technologies = () => {
  ...
  return (
    <div
      id='Technologies'
      className={`${
        animate ? 'animate-scroll_animate visible' : 'invisible'
      } flex flex-col justify-center items-center w-full min-h-screen bg-bg_qr_image bg-fixed gap-11 py-24 px-6 text-white sm:px-12 lg:px-24 `}
    >
