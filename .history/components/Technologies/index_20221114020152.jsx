...
const techArray = () => {
  ...
  return { TITLE, FRONTEND, BACKEND, TOOLS, SOON };
};

const Technologies = () => {
  const { FRONTEND, BACKEND, TOOLS, SOON } = techArray();
  return (
    <div className='flex flex-col justify-center items-center w-full min-h-screen bg-bg_qr_image bg-fixed gap-11 pt-4 px-4 text-white md:px-20 lg:px-24 '>
      ...
      <div className='flex flex-row justify-center items-center max-w-4xl'>
        ...
        <section className='z-40 group relative flex flex-col bg-white shadow-lg border-2 border-[#b2fcfb] w-8/12 p-7 gap-8 rounded-lg image-filter'>
          ...
          <TechStack tech={TOOLS} title='OTHERS'/>
