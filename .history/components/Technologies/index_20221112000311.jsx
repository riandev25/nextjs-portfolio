          ...
          <ul className='grid grid-cols-3 gap-3'>
            {FRONTEND.map((item) => {
              return (
                <li
                  key={item}
                  className='grid grid-cols-3 border-2 rounded-lg bg-gray-600'
                >
                  <div className='flex justify-center items-center rounded-l-lg bg-gray-700'>
                    <FontAwesomeIcon
                      icon={faCaretRight}
                  ...
                  <div className='border-l-2 py-3 pl-1'>
