  ...
  return (
    <div className='pt-4 flex flex-col w-full h-screen gap-11 justify-center items-center text-white px-20 bg-bg_about_image bg-fixed'>
      ...
      <div className='max-w-4xl flex flex-row'>
        ...
        <section className='flex flex-col bg-white border-2 border-[#b2fcfb] w-full p-7 gap-8 rounded-lg image-filter'>
          <ul className='grid grid-cols-3 gap-3'>
            {FRONTEND.map((item) => {
              return (
                <li
                  key={item}
                  className='grid grid-cols-3 border-2 rounded-lg border-gray-700'
                >
                  <div className='flex justify-center items-center rounded-l-lg bg-gray-300'>
                    <FontAwesomeIcon
                      icon={faCaretRight}
                  ...
                  <div className='border-l-2 border-gray-700 py-3 pl-1'>
                    <span className='col-span-2 text-base text-gray-700 my-2 '>
                      {item}
                    </span>
                  </div>
                </li>
