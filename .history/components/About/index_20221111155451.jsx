    ...
    <div className='pt-4 w-full h-screen flex flex-col gap-11 justify-center items-center text-white px-20 bg-bg_home_image bg-fixed'>
      ...
      <div className='max-w-3xl flex flex-row gap-6'>
        ...
        <section className='relative'>
          ...
          />
          <div className='absolute top-0 left-0 w-[300px] h-[300px] bg-transparent border-2 border-[#b2fcfb] transition-duration-150 translate-x-3 translate-y-3 z-10 rounded-md peer-hover:translate-x-2 peer-hover:translate-y-2 '></div>
        </section>
      </div>
    </div>
  );
