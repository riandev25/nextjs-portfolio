    ...
    >
      ...
      >
        ...
        <figure className='relative'>
          ...
          <Parallax opacity={[1, 0]} translateY={[-50, 0, 'easeInOut']}>
            <div className='z-10 hidden md:flex absolute top-0 left-0 w-[300px] h-[300px] border-2 border-[#b2fcfb] rounded-md bg-transparent translate-x-3 translate-y-3 ease-in-out transition-duration-300 delay-300 peer-hover:translate-x-2 peer-hover:translate-y-2'></div>
          </Parallax>
          <Image
