...
const About = () => {
  return (
    <div className='relative pt-4 w-full min-h-screen flex flex-col gap-11 justify-center items-center text-white px-4 bg-bg_chip_image bg-fixed'>
      {/* <Contacts /> */}
      <PageHeader title='About me' />
      <div className='flex flex-row max-w-5xl gap-6 '>
        <section className='flex flex-col max-w-md gap-4'>
          <p>
