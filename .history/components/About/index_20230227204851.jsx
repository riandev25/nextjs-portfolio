    ...
    >
      ...
      >
        ...
        <figure className='relative'>
          ...
          >
            <Image
              className='z-30 hidden relative peer border-2 rounded-md bg-[#b2fcfb] image-filter ring-4 ring-offset-x-2 ring-offset-y-2 md:flex'
              src={ProgrammerImage}
              alt='developer'
              width={300}
              height={300}
          ...
          <Image
            ...
            sizes='(max-width: 768px) 100vw, 50vw'
          />
          {/* <Parallax opacity={[1, 0]} className='z-10 sticky top-0 left-0'>
