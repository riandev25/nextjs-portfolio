...
const About = () => {
  return (
    <div className='pt-4 w-full h-screen flex flex-col gap-6 justify-center items-center text-white px-20 bg-gray-700'>
      <div>
      ...
      <div className='max-w-3xl flex flex-row gap-6'>
        ...
        <section className='relative'>
          ...
          />
          <div className='absolute top-0 left-0 w-[300px] h-[300px] bg-transparent border-2 border-[#b2fcfb] translate-x-3 translate-y-3 z-10'></div>
        </section>
      </div>
    </div>
  );
