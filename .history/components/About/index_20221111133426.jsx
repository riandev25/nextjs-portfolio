          ...
          <div className='flex flex-col gap-3'>
            ...
            <ul className='grid grid-cols-4 grid-flows-row gap-2'>
              {technologies.map((tech, i) => {
                const index = i + 1;
                return (
                  <li key={tech} className='{`col-span-${index % 2 === 0 ? '3' : '1'}`}flex flex-row justify-center items-center gap-1'>
              ...
              <FontAwesomeIcon icon={faCaretRight} className='w-1' />
              ...
              <li>
                <FontAwesomeIcon icon={faCaretRight} className='w-1' />
                <span className='col-span-1'>React</span>
              </li>
              <li></li>
            </ul>
          </div>
