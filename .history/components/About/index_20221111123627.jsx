...
const About = () => {
  return (
    <div className='pt-4 w-full h-screen flex flex-col gap-12 justify-center items-center text-white px-20 bg-gray-700'>
      <div>
        <h1 className='w-full text-2xl text-start'>About me</h1>
      </div>
