...
const About = () => {
  return (
    <div
      id='About'
      className='relative pt-4 w-full min-h-screen flex flex-col gap-11 justify-center items-center text-white px-8 pb-10 sm:px-12 lg:px-24 bg-bg_chip_image bg-fixed'
    >
