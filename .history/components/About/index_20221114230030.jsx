...
const About = () => {
  return (
    <div className='relative pt-4 w-full min-h-screen flex flex-col gap-11 justify-center items-center text-white px-8 pb-10 sm:px-12 lg:px-24 bg-bg_chip_image bg-fixed'>
      <PageHeader title='About me' />
      <div className='flex flex-col justify-center items-center max-w-5xl gap-12 md:flex-row md:items-start'>
