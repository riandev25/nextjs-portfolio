...
const About = () => {
  return (
    <div className='relative pt-4 w-full min-h-screen flex flex-col gap-11 justify-center items-center text-white px-4 md:px-20 lg:px-24 bg-bg_chip_image bg-fixed'>
      {/* <Contacts /> */}
      <PageHeader title='About me' />
      <div className='flex flex-col justify-center items-center max-w-5xl gap-12 md:flex-row'>
        <section className='flex flex-col md:w-[35rem] gap-4'>
          ...
          <div className='flex flex-col gap-3'>
            <p>
              Here are few technologies I&apos;ve been learning/mastering at the
              moment:
            </p>
            <ul className='grid grid-cols-5 gap-2'>
              {technologies.map((item, i) => {
                return (
                  <li
                    key={item}
                    className={`${(i + 1) % 2 === 0 ? 'col-span-3' : '2'}
