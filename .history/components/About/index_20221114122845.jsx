...
const About = () => {
  return (
    <div className='relative pt-4 w-full min-h-screen flex flex-col gap-11 justify-center items-center text-white px-8 md:px-20 lg:px-24 bg-bg_chip_image bg-fixed'>
      {/* <Contacts /> */}
