...
const About = () => {
  return (
    <div className='relative pt-4 w-full h-screen flex flex-col gap-11 justify-center items-center text-white px-20 bg-bg_chip_image bg-fixed'>
      {/* <Contacts /> */}
      <PageHeader title='About me' />
      <div className='flex flex-row max-w-3xl gap-6 '>
