...
const About = () => {
  return (
    <div className='pt-4 w-full h-screen flex flex-col gap-11 justify-center items-center text-white px-20 bg-bg_home_image bg-fixed'>
      ...
      <div className='max-w-3xl flex flex-row gap-6'>
        ...
        <section className='relative'>
          <div className='absolute z-40 w-[300px] h-[300px] bg-gray-700'></div>
          <Image
            className='relative z-50 rounded-md image-filter bg-[#b2fcfb] border-2 peer'
            src={ProgrammerImage}
            alt='developer'
            width={300}
            height={300}
          ...
          />
          <div className='absolute top-0 left-0 w-[300px] h-[300px] bg-transparent border-2 border-[#b2fcfb] transition-duration-300 delay-300 translate-x-3 translate-y-3 z-10 rounded-md peer-hover:translate-x-2 peer-hover:translate-y-2 '></div>
        </section>
      </div>
    </div>
  );
