...
const About = () => {
  return (
    <div className='pt-4 w-full h-screen flex flex-col gap-11 justify-center items-center text-white px-20 bg-bg_about_image bg-fixed'>
      ...
      <div className='max-w-3xl flex flex-row gap-6'>
        ...
        <section className='relative'>
          <div className='absolute z-30 w-[295px] h-[295px] bg-gray-700'></div>
          <Image
            className='relative z-40 rounded-md image-filter bg-[#b2fcfb] border-2 peer'
            src={ProgrammerImage}
            alt='developer'
            width={300}
            height={300}
