  ...
  return (
    <div className='pt-4 flex flex-col w-full h-screen gap-11 justify-center items-center text-white px-20 bg-bg_binary_image bg-fixed'>
      ...
      <div className='flex flex-row justify-center items-center max-w-full'>
        <section className='z-10 relative w-[37rem] aspect-[16/10] flex-auto flex image-filter'>
          <Image
            src={WeatherImage}
            alt='weather-app'
            fill
        ...
        <section
          className='z-20 w-[23rem] flex flex-col overflow-visible space-y-4 lg:w-[26rem]'
          dir='rtl'
        >
          ...
          <div className='flex w-[30rem] bg-gray-800 p-7 pl-11 pr-5 rounded-sm xl:w-[31rem]'>
