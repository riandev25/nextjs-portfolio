...
const SmallScreen = ({ title, description, tech, links, image }) => {
  return (
    <section className='relative w-full bg-gray-800 rounded-md object-cover px-9 py-12 flex flex-col gap-6'>
      <Image
        src={image}
        alt='weather-app'
        fill
        className='absolute object-cover rounded-lg brightness-[20%]'
      />
