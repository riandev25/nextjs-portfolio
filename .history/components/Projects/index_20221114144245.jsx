...
const Projects = () => {
  ...
  return (
    <div className='overflow-x-hidden pt-4 flex flex-col w-full h-screen gap-11 justify-center items-center text-white px-4 sm:px-8 md:px-12 lg:px-24 bg-bg_binary_image bg-fixed'>
      ...
      <div className='flex flex-row justify-center items-center max-w-full'>
        ...
        <section
          className='z-20 w-full bg-black px-4 py-8 md:w-[43%] md:p-0 flex flex-col overflow-visible gap-5'
