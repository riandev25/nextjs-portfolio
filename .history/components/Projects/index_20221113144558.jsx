  ...
  return (
    <div className='pt-4 flex flex-col w-full h-screen gap-11 justify-center items-center text-white px-24 bg-bg_binary_image bg-fixed'>
      ...
      <div className='flex flex-row justify-center items-center max-w-full'>
        <section className='z-10 relative w-[28rem] aspect-[16/10] flex-auto flex image-filter'>
          <Image
            src={WeatherImage}
            alt='weather-app'
            fill
        ...
        <section
          className='z-20 w-[38%] flex flex-col overflow-visible gap-5'
          dir='rtl'
        >
          ...
          <div className='flex max-w-[35rem] bg-gray-800 p-5 pl-11 rounded-sm lg:w-[32rem]'>
