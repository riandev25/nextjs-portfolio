  ...
  return (
    <div className='overflow-x-hidden pt-4 flex flex-col w-full h-screen gap-11 justify-center items-center text-white px-12 md:px-12 lg:px-24 bg-bg_binary_image bg-fixed'>
      ...
      <div className='flex flex-row justify-center items-center max-w-full'>
        ...
        <section
          className='z-20 w-full bg-[WeatherImage] object-cover px-9 py-12 md:w-[43%] md:p-0 flex flex-col overflow-visible gap-6 md:gap-5'
          dir={!lessScreenMd && 'rtl'}
        >
          <div
            className='flex flex-col justify-start items-center bg-bg_weather_image object-cover md:bg-none md:justify-end md:items-end'
            dir='ltr'
          >
