      ...
      <div className='flex flex-row justify-center items-center'>
        ...
        >
          <div className='flex flex-col justify-end items-end'>
            <h2 className='w-full text-neon text-right'>Featured Project</h2>
            <h1 className='w-full text-xl font-bold text-right'>
              Weather Application
            </h1>
          </div>
          ...
          <ul className='flex flex-row justify-end items-center gap-4 w-full'>
