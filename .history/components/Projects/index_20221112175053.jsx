...
const Projects = () => {
  return (
    <div className='pt-4 flex flex-col w-full h-screen gap-11 justify-center items-center text-white px-20 bg-bg_binary_image bg-fixed'>
      ...
      <div className='bg-yellow-200 flex flex-row justify-center items-center'>
        ...
        <section className='w-5/12 gap-4'>
          <div className='flex flex-col justify-items-end bg-red-100'>
