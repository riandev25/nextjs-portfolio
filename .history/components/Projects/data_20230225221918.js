...
const PROJECT_DATA = [{
  ...
  description: 'I have built my portfolio website to showcase my projects and also to practice responsive web design and CSS animations. Soon will be converted to TypeScript',
...
},
{
  ...
  description: 'A fully responsive weather application. I built this project using OpenweathermapApi and to enhance my vanilla javascript skills. Open first the location of your device for better user experience',
...
},
{
  ...
  description: 'Task Accio&apos;s backend is a comprehensive web application that allows users to perform CRUD operations for their tasks, along with authentication for secure login. It facilitates the creation, modification, deletion, and retrieval of tasks and supports various features such as labels, checklists, and images.',
  tech: ['NodeJS', 'Express JS', 'Typescript', 'MongoDB', 'Passport Local', 'Cloudinary' ],
  links: [
    {
      id: 1,
      icon: faSquareArrowUpRight,
