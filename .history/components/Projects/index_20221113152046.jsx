...
const Projects = () => {
  return (
    <div className='pt-4 flex flex-col w-screen h-screen gap-11 justify-center items-center text-white px-24 bg-bg_binary_image bg-fixed'>
      ...
      <div className='flex flex-row justify-center items-center max-w-full'>
        ...
        >
          ...
          <div className='flex bg-gray-800 p-5 pl-11 rounded-sm w-[25rem] lg:w-[33rem]'>
