...
const Projects = () => {
  return (
    <div className='overflow-x-hidden pt-4 flex flex-col w-full h-screen gap-11 justify-center items-center text-white px-8 md:px-24 bg-bg_binary_image bg-fixed'>
